...
import 'package:talabat/features/auth/presentation/view_model/login_view_model/login_view_model_states.dart';
...
class _LoginWithEmailBodyState extends State<LoginWithEmailBody> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocListener<LoginViewModel, LoginViewModelStates>(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextFormField(
                ...
                onSaved: (p0) => loginViewModel.emailController.text = p0!,
                iconShow: false,
                validator: (p0) {
              ...
              CustomTextFormField(
                ...
                onSaved: (p0) => loginViewModel.passwordController.text = p0!,
                iconShow: true,
                validator: (p0) {
              ...
              CustomBotton(
                ...
                ontap: ()async {
                  if (loginViewModel.formKey.currentState!.validate()) {
                    ...
                    setState(() {
                      loginViewModel.autovalidateMode = AutovalidateMode.onUserInteraction;
                    });
                  }
                },
              ),
